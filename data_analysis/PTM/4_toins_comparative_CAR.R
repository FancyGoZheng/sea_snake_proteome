DIA <- read.xlsx("DIA_CAR_pos.xlsx",sheetIndex = 1,header = T,colIndex = c(1,2))
TMT <- read.xlsx("TMT-car_pos_outdata.xlsx",sheetIndex = 1,header = T,colIndex = c(2,3))
data1 <- DIA
data2 <- TMT
# 提取蛋白ID
...
write.xlsx(result ,"OUTPUT-Hc-car位点比较.xlsx")
